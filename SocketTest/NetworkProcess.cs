...
namespace SocketTest
{
    class NetworkProcess
    {
        ...
        public NetworkProcess() { Console.WriteLine("Hello world"); }
        ...
        private void SaveData(string content)
        {
            ...
            string curUser = data.id;

            // Get Altitude
            // using flightplanner.cs srtm class 
            // var altdata= srtm.getAltitude(last.latitude, last.longitude);
            double alt = 0.0;// = altdata.alt + (원하는 값);
            data.altitude = alt;
        ...
        private void SaveLocToWPFile(string _id)
        {
            ...
            DataType last = list[list.Count - 2];
            ...
            wpForm += ("0\t1\t0\t16\t0\t0\t0\t0\t" + last.latitude + "\t" + last.longitude + "\t"
                + last.altitude + "\t1\n");
